# Terraform configuration for n8n-scraper cloud infrastructure
...
terraform {
  ...
  # Note: Configure backend via terraform init -backend-config or backend.hcl file
  # backend "s3" {
  #   bucket         = "your-terraform-state-bucket"
  #   key            = "n8n-scraper/terraform.tfstate"
  #   region         = "us-west-2"
  #   encrypt        = true
...
resource "aws_security_group" "alb" {
  ...
  tags = {
    Name = "${var.project_name}-main-alb-sg"
  }
}
...
# Helm Release for n8n-scraper application
resource "helm_release" "n8n_scraper" {
  name       = "n8n-scraper"
  repository = "./helm"
  chart      = "n8n-scraper"
  ...
  values = [
    file("${path.module}/../helm/n8n-scraper/values.yaml")
  ]
